  ...
  constructor(props) {
    ...
    this.transformMode = {
      translate: {
        ...
        changeTranformFunc: this.changeTransformModeFuncFactory('translate'),
        iconComponent: (
          <svg 
      ...
      rotate: {
        ...
        changeTranformFunc: this.changeTransformModeFuncFactory('rotate'),
        iconComponent: (
          <svg 
      ...
      scale: {
        ...
        changeTranformFunc: this.changeTransformModeFuncFactory('scale'),
        iconComponent: (
        ...
        ({ messages }) => (
          <>
            {props.modes.map((mode, idx) => {              
              const isRotate = editorMode === this.transformMode.rotate.id;
              const isScale = editorMode === this.transformMode.scale.id;
              switch (mode) {
                case 'translate': {
                  const transformMode
                  const isTranslateSelected = editorMode === this.transformMode.translate.id;
                  return (
                    <button 
                      key="translate"
                      className={isTranslateSelected ? "selected" : ""}
                      onClick={this.changeTransformModeFunc.translate}
